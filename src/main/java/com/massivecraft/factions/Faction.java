...
public interface Faction extends EconomyParticipator {
    ...
    void setShieldStart(long shieldStart);

    long getShieldStart();

    void setShieldEnd(long shieldEnd);

    long getShieldEnd();

    void setShieldPlanned(boolean shieldStatus);

    boolean getShieldPlanned();

    void setShieldRunning(boolean shieldRunning);

    boolean getShieldRunning();
