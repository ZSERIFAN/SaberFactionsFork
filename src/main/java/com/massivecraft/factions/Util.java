...
public class Util {
    ...
    public static void registerChecks() {
        if (Conf.useCheckSystem) {
            ...
            FactionsPlugin.instance.getServer().getScheduler().runTaskTimerAsynchronously(FactionsPlugin.instance, new ShieldTask(FactionsPlugin.instance), 20L, 20L);
        }
    }
    ...
    public static void initSetup() {
        ...
        FactionsPlugin.instance.cachedRadiusClaim = Conf.useRadiusClaimSystem;
        ...
        System.out.println("[SABER-FACTIONS] - Loaded " + FactionsPlugin.instance.getTimers().size() + " timers into list!");
        ...
        if (Conf.useGraceSystem) FactionsPlugin.instance.getServer().getPluginManager().registerEvents(FactionsPlugin.instance.timerManager.graceTimer, FactionsPlugin.instance);

        FactionsPlugin.instance.getCommand(FactionsPlugin.instance.refCommand).setExecutor(FactionsPlugin.instance.cmdBase);
        if (!CommodoreProvider.isSupported()) FactionsPlugin.instance.getCommand(FactionsPlugin.instance.refCommand).setTabCompleter(FactionsPlugin.instance);
