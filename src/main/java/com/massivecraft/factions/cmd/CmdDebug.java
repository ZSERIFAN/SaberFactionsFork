...
public class CmdDebug extends FCommand {
    ...
    public void perform(CommandContext context) {
        ...
        System.out.print("SaberFactions com.massivecraft.factions.Version: " + FactionsPlugin.getInstance().getDescription().getVersion());
        ...
        System.out.print("Shield command: " + FCmdRoot.instance.fShieldEnabled);
