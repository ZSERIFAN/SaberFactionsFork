...
public class FCmdRoot extends FCommand implements CommandExecutor {
    ...
    public CmdForceShield cmdForceShield = new CmdForceShield();
    ...
    public Boolean fShieldEnabled = false;
    ...
    public FCmdRoot() {
        ...
        this.addSubCommand(this.cmdForceShield);
        addVariableCommands();
    ...
    public void addVariableCommands() {
        ...
        if (FactionsPlugin.getInstance().getConfig().getBoolean("fshield.Enabled", true) && !fShieldEnabled) {
            this.addSubCommand(this.cmdShield);
            fShieldEnabled = true;
        }
    }
