...
public enum TL {
     ...
     * Translation meta
     */
    _AUTHOR("root.AUTHOR", "misc"),
    _RESPONSIBLE("root.RESPONSIBLE","misc"),
    _LANGUAGE("root.LANGUAGE","English"),
    _ENCODING("root.ENCODING","UTF-8"),
    _LOCALE("root.LOCALE","en_US"),
    _REQUIRESUNICODE("root.REQUIRESUNICODE","false"),
    _DEFAULT("root.DEFAULT","true"),
    _STATE("root.STATE","complete"), //incomplete, limited, partial, majority, complete

    /**
     * Localised translation meta
     */
    _LOCAL_AUTHOR("root.LOCAL.AUTHOR","misc"),
    _LOCAL_RESPONSIBLE("root.LOCAL.RESPONSIBLE","misc"),
    _LOCAL_LANGUAGE("root.LOCAL.LANGUAGE", "English"),
    _LOCAL_REGION("root.LOCAL.REGION", "US"),
    _LOCAL_STATE("root.LOCAL.STATE", "complete"), //And this is the English version. It's not ever going to be not complete.
    /**
    ...
    SHIELD_EXPIRED_MESSAGE("&c&l[!]&7 Your faction shield has expired!"),
    SHIELD_ALREADY_RUNNING("&c&l[!]&7 There is a shield already running! {time} left"),
    SHIELD_PLANNED("&c&l[!] &7Shield planned from &c{from} &7to &c{to}&7!"),
    SHIELD_STARTED("&c&l[!] &7Shield started! Ends at &c{to}&7!"),
    SHIELD_SCHEDULED("&c&l[!] &7Scheduled shield from &c{from} &7to &c{to}&7!"),

    FORCESHIELD_CANCELLED_BY_ADMIN("&c&l[!] &7Your shield has been cancelled by admin &c{player}&7!"),
    ...
    COMMAND_SHIELD_SUCCESS("&aEnabled faction shield!"),
    COMMAND_SHIELD_DISABLED("&c&l[!] &7Factions shields are currently disabled!"),

    COMMAND_FORCESHIELD_DESCRIPTION("[Admin Command] Forcefully ends a faction's shield."),
