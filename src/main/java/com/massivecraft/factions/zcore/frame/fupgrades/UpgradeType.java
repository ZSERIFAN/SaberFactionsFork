...
import com.massivecraft.factions.PlaceholderUtil;
...
public enum UpgradeType {
    ...
    public ItemStack buildAsset(Faction f) {
        ...
        if (meta != null) {
            meta.setLore(Util.colorList(PlaceholderUtil.replacePlaceholders(config.getStringList("Lore"), new Placeholder("{level}", level + ""))));
